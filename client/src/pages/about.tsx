...
const milestones = [
  { year: "2024", event: "회사 설립, 산업용 로봇 연구 시작" },
  { year: "2024", event: "첫 형강 절단 자동화 시스템 개발" },
  { year: "2025", event: "HD현대중공업 기존 형강 절단 자동화 시스템 개조 공사 (배출보조장치 증설)" },
  { year: "2025", event: "산업용 AMR 프로토타입 완성" },
  { year: "2025", event: "한화오션 첫 형강 절단 자동화 토탈 시스템 납품" },
  { year: "2026", event: "Physical AI 기술 개발 착수" },
          ...
          <div className="max-w-7xl mx-auto px-4 lg:px-8">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                ROBOTICS는 2024년 설립 이래 조선·건설 산업에 특화된 자동화 솔루션을
              ...
              <Card className="p-6">
                <CardContent className="p-0">
                  ...
                  <p className="text-muted-foreground mb-4">
                    ...
                    핵심 기술에 대한 3건 이상의 국내외 특허를 보유하고 있습니다.
                  </p>
              ...
              <Card className="p-6">
                <CardContent className="p-0">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-lg font-semibold">토탈 솔루션</h3>
                  </div>
                  <p className="text-muted-foreground mb-4">
                    하드웨어 설계부터 전장, 소프트웨어까지 전 과정의 개발·운영·관리
                    경험을 보유하고 있습니다. 프로젝트 총괄 역량을 바탕으로 통합
                    솔루션을 제공합니다.
                  </p>
                  <div className="flex flex-wrap gap-2">
                    <Badge variant="secondary">기구 설계</Badge>
                    <Badge variant="secondary">전장 설계</Badge>
                    <Badge variant="secondary">제어 SW</Badge>
                    <Badge variant="secondary">운영 SW</Badge>
                  </div>
                </CardContent>
              </Card>
            </div>
